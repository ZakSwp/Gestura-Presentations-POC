...
class Text(QGraphicsTextItem):
    def __init__(self, text,view:QGraphicsView, parent=None):
        ...
        self.rotCursor= QCursor(QPixmap(resource_path("doubleRot.png")).scaled(40, 40, Qt.KeepAspectRatio,Qt.SmoothTransformation))
...
""")
            ...
            sendToBackAction.setIcon(QIcon(resource_path("send-back.ico")))
...
""")
            ...
            icon=QIcon(resource_path("send-back.ico"))
...
class Video(Image):
    ...
    def paintPlayPause(self,painter:QPainter):
        ...
        self.playRect.moveCenter(self.rect().center())
        if self.playing:
            self.playImage=QPixmap(resource_path("pause.png")).scaled(50, 50, Qt.KeepAspectRatio,Qt.SmoothTransformation).toImage()
             
        else:
            self.playImage=QPixmap(resource_path("play.png")).scaled(50, 50, Qt.KeepAspectRatio,Qt.SmoothTransformation).toImage()
        if self.play:
            self.playImage=QPixmap(resource_path("play.png")).scaled(50, 50, Qt.KeepAspectRatio,Qt.SmoothTransformation).toImage()   
